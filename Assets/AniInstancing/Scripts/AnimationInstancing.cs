...
namespace AnimationInstancing
{
    ...
    public class AnimationInstancing : MonoBehaviour
    {
        ...
        public string animDataFileName = "";
        ...
        public bool InitializeAnimation()
        {
            ...
            if (lodInfo[0].skinnedMeshRenderer.Length == 0)
            {
                ...
                isMeshRender = true;
                AnimationInstancingMgr.Instance.AddMeshVertex(animDataFileName,
                    lodInfo,
                    null,
                    null,
                    bonePerVertex);
            ...
            AnimationManager.InstanceAnimationInfo info = AnimationManager.Instance.FindAnimationInfo(prototype, animDataFileName, this);
            if (info != null)
            {
