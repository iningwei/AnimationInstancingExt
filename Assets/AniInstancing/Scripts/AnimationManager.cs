...
namespace AnimationInstancing
{
    public class AnimationManager : AnimInsSingleton<AnimationManager>
    {
        ...
        public InstanceAnimationInfo FindAnimationInfo(GameObject prefab, string animDataFileName, AnimationInstancing instance)
        {
            ...
            if (m_useBundle)
            {
                ...
                return CreateAnimationInfoFromFile(prefab, animDataFileName);
        }
        ...
        private InstanceAnimationInfo CreateAnimationInfoFromFile(GameObject prefab, string animDataFileName)
        {
            Debug.Assert(prefab != null);
            string path;
            ...
            AnimationInstancingMgr.Instance.ImportAnimationTexture(animDataFileName, reader);
            file.Close();
#elif UNITY_IPHONE
